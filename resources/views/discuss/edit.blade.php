...
@push('scripts')
    ...
    $(document).ready(function() {
        ...
        $('.btn-edit-discussion').click(function() {
            var id = $(this).data('id');
            var content = $(this).data('content');
            var discussionContent = $('.card[data-id="' + id + '"]').find('.discussion-content');
            var discussionEditInput = $('.card[data-id="' + id + '"]').find('.discussion-edit-input');

            // Sembunyikan konten diskusi dan tampilkan input teks
            discussionContent.hide();
            discussionEditInput.val(content).show();
        });

        // Saat tombol simpan ditekan
        $('.btn-save-discussion').click(function() {
            var id = $(this). --}}
